...
- Просмотр всех клиентов, их дат, и ссылок `sudo ./xray_user_show all`
- Просмотр клиентов забаненых вручную `sudo ./xray_user_show blk`
...
- добавить что бы в цикле добавлялись юзеры из файла базы
